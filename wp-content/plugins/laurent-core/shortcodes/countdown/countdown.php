<?php
namespace LaurentCore\CPT\Shortcodes\Countdown;
...
class Countdown implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Countdown', 'laurent-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Light', 'laurent-core' )   => 'eltdf-light-skin',
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'year',
							'heading'     => esc_html__( 'Year', 'laurent-core' ),
							'value'       => array(
								'2018' => '2018',
								'2019' => '2019',
								'2020' => '2020',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'month',
							'heading'     => esc_html__( 'Month', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'January', 'laurent-core' )   => '1',
								esc_html__( 'February', 'laurent-core' )  => '2',
								esc_html__( 'March', 'laurent-core' )     => '3',
								esc_html__( 'April', 'laurent-core' )     => '4',
								esc_html__( 'May', 'laurent-core' )       => '5',
								esc_html__( 'June', 'laurent-core' )      => '6',
								esc_html__( 'July', 'laurent-core' )      => '7',
								esc_html__( 'August', 'laurent-core' )    => '8',
								esc_html__( 'September', 'laurent-core' ) => '9',
								esc_html__( 'October', 'laurent-core' )   => '10',
								esc_html__( 'November', 'laurent-core' )  => '11',
								esc_html__( 'December', 'laurent-core' )  => '12'
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'day',
							'heading'     => esc_html__( 'Day', 'laurent-core' ),
							'value'       => array(
								'1'  => '1',
								'2'  => '2',
								'3'  => '3',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hour',
							'heading'     => esc_html__( 'Hour', 'laurent-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'minute',
							'heading'     => esc_html__( 'Minute', 'laurent-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							...
							'heading'    => esc_html__( 'Month Label', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'day_label',
							'heading'    => esc_html__( 'Day Label', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'hour_label',
							'heading'    => esc_html__( 'Hour Label', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'minute_label',
							'heading'    => esc_html__( 'Minute Label', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'second_label',
							'heading'    => esc_html__( 'Second Label', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit_font_size',
							'heading'    => esc_html__( 'Digit Font Size (px)', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'label_font_size',
							'heading'    => esc_html__( 'Label Font Size (px)', 'laurent-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/countdown', 'countdown', '', $params );

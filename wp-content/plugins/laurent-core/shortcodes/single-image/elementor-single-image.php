<?php
class LaurentCoreElementorSingleImage extends \Elementor\Widget_Base {

	public function get_name() {
		return 'eltdf_single_image'; 
	}

	public function get_title() {
		return esc_html__( 'Single Image', 'laurent-core' );
	}

	public function get_icon() {
		return 'laurent-elementor-custom-icon laurent-elementor-single-image';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'svg_image',
			[
				'label'     => esc_html__( 'SVG Image Path', 'laurent-core' ),
		...
		$this->add_control(
			'enable_ornament',
			[
				'label'     => esc_html__( 'Enable Ornamental Background', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'no' => esc_html__( 'No', 'laurent-core'), 
					'yes' => esc_html__( 'Yes', 'laurent-core')
		...
		$this->add_control(
			'ornament_shape',
			[
				'label'     => esc_html__( 'Ornament Shape', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'rectangle' => esc_html__( 'Rectangle', 'laurent-core'), 
					'ellipse' => esc_html__( 'Ellipse', 'laurent-core'), 
					'triangle' => esc_html__( 'Triangle', 'laurent-core'), 
					'custom' => esc_html__( 'Custom', 'laurent-core')
				),
				'default' => 'rectangle',
				'condition' => [
					'enable_ornament' => array( 'yes' )
				]
			]
		);
		...
		$this->add_control(
			'ornament_svg_path',
			[
				'label'     => esc_html__( 'Ornament SVG Path', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::TEXTAREA,
		...
		$this->add_control(
			'ornament_color',
			[
				'label'     => esc_html__( 'Ornament Color', 'laurent-core' ),
		...
		$this->add_control(
			'ornament_width',
			[
				'label'     => esc_html__( 'Ornament Width (%)', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'ornament_height',
			[
				'label'     => esc_html__( 'Ornament Height (%)', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'ornament_top',
			[
				'label'     => esc_html__( 'Ornament Top Offset (px or %)', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'ornament_right',
			[
				'label'     => esc_html__( 'Ornament Right Offset (px or %)', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				...
				'options' => array(
					...
					'moving' => esc_html__( 'Moving on Hover', 'laurent-core')
				),
				'default' => '',
				'condition' => [
					'image!' => ''
		...
		$this->add_control(
			'appear_effect',
			[
				'label'     => esc_html__( 'Appear Effect', 'laurent-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
	...
	public function render() {
		...
		$params['ornament_svg_path']  = base64_encode( urlencode( $params['ornament_svg_path'] ));
        ...
        $params['svg_image']          = base64_encode( urlencode( $params['svg_image'] ));

        echo laurent_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new LaurentCoreElementorSingleImage() );